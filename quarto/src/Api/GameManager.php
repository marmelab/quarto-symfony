...
class GameManager
{
    ...
    public function newGame(int $size, string $avatar = '') : Game
    {
        $game = Game::new($size, $avatar);
        $this->gameRepository->save($game);
        return $game;
    }

    public function newGameSolo(int $size, string $avatar = '') : Game
    {
        $game = $this->newGame($size, $avatar);
